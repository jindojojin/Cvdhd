...
// const HTTP = require('../HttpControler');
var AutoComplete = require("autocomplete-js");
function pushCowInfoData(){
    let cowInfo = getCowInfo();
    if(validateCowInfo(cowInfo)){
        console.log(cowInfo);
        var response = HTTP.post('/addCow',cowInfo) // Đẩy thông tin lên server tập trung
...
},{"autocomplete-js":7}],2:[function(require,module,exports){
...
require('./CowComponent/AddCow/addcow');
require('./CowComponent/CowHealth/cowhealth');
require('./CowComponent/Food/food');
require('./CowComponent/SellCow/sellcow');
require('./CowComponent/Vaccine/vaccine');
},{"./CowComponent/AddCow/addcow":1,"./CowComponent/CowHealth/cowhealth":2,"./CowComponent/Food/food":3,"./CowComponent/SellCow/sellcow":4,"./CowComponent/Vaccine/vaccine":5}],7:[function(require,module,exports){
(function (global){
